...
export default function ProfilePage() {
    ...
    const [creaPostClicked, setCreaPostClicked] = useState(false)
    ...
    return (
        <div className="mx-auto grid w-full max-w-[1440px] grid-cols-1 sm:px-4 lg:grid-cols-[260px_minmax(0,1fr)_260px] xl:grid-cols-[300px_minmax(0,1fr)_300px]">
            ...
            <main className="min-w-0">
                <ProfilePageHero isCreatingPost={creaPostClicked} setPostClicked={setCreaPostClicked} />
            </main>
            <aside className="hidden lg:block" />
            {creaPostClicked && <PostForm/>}
