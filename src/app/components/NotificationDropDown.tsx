...
const NotificationDropDown = () => {
    ...
    return (
        <div className={`${show ? `d-block` : `d-none`} bg-white text-black position-absolute pe-3 py-2 rounded-2 shadow`} style={{minWidth:'30vw',zIndex: 2000, right: '1vh', boxShadow: '4px -2px 8px rgba(0, 0, 0, 0.1) !important'}}>
